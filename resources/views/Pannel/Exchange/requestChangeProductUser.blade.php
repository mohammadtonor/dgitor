                        ...
                        <div class="card " style="height: 150px">
                            <div class="card-body">
                                <img src="{{asset("./assets/images/numberOfProductIcon.jpg")}}"  alt="cart" class="float-left"
                                     width="75" height="70" >
                                <h6 class="card-title font-weight-bold"> تعداد درخواست ها </h6>
                                <h2>26476</h2>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-content">
                            <div class="card-body" style="margin: 20px">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="navs-determinationProduct-tab" data-toggle="tab" href="#tabs-myProduct"> انتخاب کالای من</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="tab-content">
                                    <div id="tabs-myProduct" class="container tab-pane fade active"><br>
                                        <div class="col-12 align-self-center mt-3">
                                            <div class="card col-12 m-0 p-0">
                                                <div class="card-content">
                                                    <div class="card-body" style="margin: 20px">
