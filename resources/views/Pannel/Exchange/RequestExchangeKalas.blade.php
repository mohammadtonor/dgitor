...
@section("content")
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid align-self-center mt-3">
                    <div class="card col-12 m-0 p-0">
                        <h4 style="margin: 20px 45px 10px 15px"> درخواست معاوضه کالا [کل کالاها - کارمند] </h4>
                                        ...
                                        <div class="form-group col-sm-12 col-md-2">
                                            <div class="field_wrapper">
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control searchCity" name="searchCity"
                                                            id="searchCity">
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                                <div class="card-body mt-1">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-hover table-dark table-striped w-100 myTableRequestExchangeKalas " id="myTableRequestExchangeKalas">
                                                            <thead>
                                                            <tr class="text-center">
                                                                <th class="rowcount">ردیف</th>
                                                                <th class="">کالا</th>
                                                            ...
                                                            <tr class="text-center">
                                                                ...
                                                                <td class="d-flex justify-content-center">
                                                                    <button class="btn btn-sm btn-danger ml-2 mt-1 deleteExchangeKala" id="deleteExchangeKala" data-target="#deleteExchangeKalaModal"
                                                                            data-toggle="modal">
                                                                        <i class="icon-trash " aria-hidden="true" data-toggle="tooltip"
                                                                           data-placement="top"
                                                                           title="حذف"></i>
                                                                    </button>
                                                                    <button class="btn btn-sm btn-warning ml-2 mt-1 restoreExchangeKala" id="restoreExchangeKala" data-target="#restoreExchangeKalaModal"
                                                                            data-toggle="modal">
                                                                    ...
                                                                    <button class="btn btn-sm btn-primary ml-2 mt-1"
                                                                            ...
                                                                            data-toggle="modal">
                                                                        <i class="icon-phone" aria-hidden="true" data-toggle="tooltip"
                                                                           data-placement="top"
                                                                           title="اطلاعات تماس"></i>
                                                                    </button>
    ...
    <!--حذف-->
    <div class="modal" id="deleteExchangeKala" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
         aria-hidden="true">
        <div class="modal-dialog-centered modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header justify-content-between">
                    <h5 class="modal-title">حذف معاوضه کالا</h5>
    ...
    <div class="modal" id="deleteExchangeKala" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog-centered modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header justify-content-between">
                    <h5 class="modal-title">بازیابی معاوضه کالا</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-left: 0">
                        <span aria-hidden="true" class="text-left">&times;</span>
                    </button>
                </div>
...
@section("pagejs")
    ...
    <script >
        ...
        let myTablePersonnelList = $('#myTableRequestExchangeKalas').DataTable({
            "order": [],
            "columnDefs": [{
                "targets": 'no-sort',
                "orderable": false,
