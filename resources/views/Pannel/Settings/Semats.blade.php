...
@section("content")
            ...
            <div class="container-fluid">
                ...
                <div class="row categ">
                    <div class="col-12 col-sm-6 col-xl-3 mt-3">
                        <div class="card">
                            <div class="card-body">
                                <img src="{{asset("./assets/images/semats-removebg-preview.png")}}" alt="cart"
                                     class="float-left"
                                     width="100" height="100">
                                <h6 class="card-title font-weight-bold"> تعداد سمت ها</h6>
                                <h2>26476</h2>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-content">
                            <div class="card-body" style="margin: 20px">
                                <button class="btn btn-lg btn-primary  my-2" data-toggle="modal"
                                        data-target="#btncreatenewsemat"> سمت جدید
                                </button>
                                <div class="table-responsive">
                                    <table class="table table-hover table-dark table-striped" id="tableSemat">
                                        <thead>
                                        <tr class="text-center">
                                            <th class="rowcount">ردیف</th>
                                            <th class="nameSemat">نام</th>
                                            <th class="status">وضعیت</th>
                                            <th class="userCount">تعداد کاربر</th>
    ...
    <!--MODAL-->
    <!--ایجاد سمت-->
    <div class="modal" id="btncreatenewsemat" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
         aria-hidden="true">
        <div class="modal-dialog-centered modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">ایجاد سمت</h5>
                ...
                <div class="modal-body p-3">
                    <form class=" ">
                        <div class="input-group mt-2">
                            ...
                            <input id="insertsematname" type="text" class="form-control inp" aria-label="Default"
                        ...
                        <div class="input-group mt-3">
                            ...
                            <select id="statusselect" class="form-control" style="height: auto">
                    ...
                    <div class="row mt-3" style="justify-content: center">
                        ...
                        <div class="col-6">
                            <button id="insertsemat" type="button" class="btn btn-success w-100" data-dismiss="modal">ثبت
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <!-- ویرایش -->
    <div class="modal" id="editsemat" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
         aria-hidden="true">
        <div class="modal-dialog-centered modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">ویرایش سمت </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-left: 0">
                        <span aria-hidden="true" class="text-left">&times;</span>
                    </button>
                </div>
                <div class="modal-body p-3">
                    <form class=" ">
                        <div class="input-group mt-2">
                            <div class="input-group-prepend">
                                <span class="input-group-text"> نام سمت </span>
                            </div>
                            <input id="sematnameedit" type="text" class="form-control" aria-label="Default"
                                   aria-describedby="inputGroup-sizing-default">
                        </div>
                        <div class="input-group mt-3">
                            <div class="input-group-prepend">
                        ...
                        <select id="statusselectedit" class="form-control" style="height: auto">
                            <option value="1">فعال</option>
                            <option value="0">غیر فعال</option>
                        </select>
                        </div>
                    ...
                    <div class="row mt-3" style="justify-content: center">
                        ...
                        <div class="col-6">
                            <button id="doeditsemat" type="button" class="btn btn-success w-100" data-dismiss="modal" data-recordid>ثبت
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <!--حذف-->
    <div class="modal" id="deleterole" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
         aria-hidden="true">
        <div class="modal-dialog-centered modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header justify-content-between">
                    <h5 class="modal-title">حذف سمت</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-left: 0">
                        <span aria-hidden="true" class="text-left">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal" id="restoremodal" tabindex="-1" role="dialog" aria-labelledby=""
        ...
        <div class="modal-dialog-centered modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">بازیابی سمت</h5>
    ...
    {{--  دسترسی ها  --}}
    <div class="modal" id="accesses" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
         aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title col">دسترسی ها</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="input-group my-2 col-md-12 ">
                                <div class="input-group">
                                    <div class="input-group-prepend ">
                                        <span class="input-group-text mb-0 pb-0">دسترسی ها </span>
                                    </div>
                                    <select id="lessons"
...
@section("pagejs")
    ...
    <script src="{{asset('./assets/js/Pannel/Settings/semats.js')}}"></script>
