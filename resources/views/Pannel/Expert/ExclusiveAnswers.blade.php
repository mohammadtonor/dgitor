                        ...
                        <div class="card" style="height: 150px">
                            <div class="card-body" >
                                <img src="{{asset("./assets/images/questionCount-icon.png")}}" alt="cart"
                                     class="float-left"
                                     width="70" height="70">
                                <h6 class="card-title font-weight-bold mt-2"> تعداد پاسخ </h6>
                                <h2 class="mt-3">26</h2>
                        ...
                        <div class="card" style="height: 150px">
                            <div class="card-body" >
                                <img src="{{asset("./assets/images/acctiveQuestion-icon.png")}}" alt="cart"
                                     class="float-left"
                                     width="70" height="70">
                                <h6 class="card-title font-weight-bold mt-2"> تعداد پاسخ های فعال </h6>
                                <h2 class="mt-3">26</h2>
                        ...
                        <div class="card-content">
                            <div class="card-body" style="margin: 20px">
                                <button class="btn btn-lg btn-primary insertNewModal my-3" data-toggle="modal" id="insertNewModal"
                                        data-target="#insertNewModal">ثبت پاسخ جدید
                                </button>

                                <h2 class="my-2">متن سوال :........</h2>

                                <div class="table-responsive">
                                    <table class="table table-hover table-dark table-striped myTableExclusiveAnswers" id="myTableExclusiveAnswers">
                                        <thead>
                                        <tr class="text-center">
                                            <th class="rowcount">ردیف</th>
                                            <th class="">متن پاسخ</th>
                                            <th class=""> وضعیت </th>
        ...
        <div class="modal-dialog-centered modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body p-3">
                    ...
                    <div class="row mt-3" style="justify-content: center">
                        <div class="col-6">
                            <button type="button" class="btn btn-success w-100" data-dismiss="modal" id="doEditeModal">ثبت</button>
                        </div>
                        <div class="col-6">
        ...
        <div class="modal-dialog-centered modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header justify-content-between">
                    <h5 class="modal-title">تایید پاسخ</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-left: 0">
                        <span aria-hidden="true" class="text-left">&times;</span>
                    </button>
                </div>
                <div class="modal-body p-3">
                    <h5 style="text-align: center">ایا این پاسخ را تایید می کنید ؟</h5>

                    <div class="row mt-3" style="justify-content: center">
                        <div class="col-6">
                            <button id="doAcceptModal" type="button" class="btn btn-success w-100" data-dismiss="modal"
                                    data-recordid="">بلی
                            </button>
                        </div>
                        <div class="col-6">
...
@section("pagejs")
    ...
    <script>
        $(document).ready(function () {
            $('#myTableExclusiveAnswers').DataTable({
                "order": [],
                "columnDefs": [{
                    "targets": 'no-sort',
                    "orderable": false,
