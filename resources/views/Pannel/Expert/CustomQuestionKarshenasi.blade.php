...
@section("content")
                        ...
                        <div class="card">
                            <div class="card-body">
                                <img src="{{asset("/assets/images/employee-icon-1-removebg-preview.png")}}" alt="cart"
                                     class="float-left"
                                     width="130" height="70">
                                <h6 class="card-title font-weight-bold">تعداد کل سوالات</h6>
                                <h2>26476</h2>
                        ...
                        <div class="card-content">
                                <div class="card-body" style="margin: 20px">
                                    <button class="btn  btn-primary my-2" data-toggle="modal"
                                            data-target="#btncreatenewquestion">ثبت سوال جدید
                                    </button>
                                    <div class="mt-3 mb-2">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-sm-12 col-md-2">
                                                <div class="field_wrapper">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text"> دسته 4</div>
                                                        </div>
                                                        <select class="form-control" name="main_category_id"
                                                                id="main_category_selectbox">
                                                            <option value="">انتخاب کنید</option>
                                    ...
                                    <div class="table-responsive">
                                        <table
                                            ...
                                            id="tableGerneralKarshenasiQuestion">
                                            <thead>
                                            <tr class="text-center">
                                                <th class="rowcount">ردیف</th>
                                                <th class="firstName">عنوان</th>
                                                <th class="lastName">ثبت کننده</th>
                                                <th class="codeNum">وضعیت</th>
                                                <th class="insertTime">تاریخ ثبت</th>
                                                <th class="deleteTime">تاریخ حذف</th>
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    ...
                                                    <button class="btn btn-sm btn-danger ml-2 mt-1"
                                                            data-target="#confirm"
                                                            data-toggle="modal">
                                                        <i class="icon-like" aria-hidden="true"
                                                           data-toggle="tooltip "
                                                           data-placement="top"
                                                           title="تایید"></i>
                                                    </button>
    ...
    <!--MODAL-->
    <!-- ثبت سوال جدید -->
    <div class="modal" id="btncreatenewquestion" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
         aria-hidden="true">
        <div class="modal-dialog-centered modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">ثبت سوال جدید</h5>
    ...
    {{--  تایید  --}}
    <div class="modal" id="confirm" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
         aria-hidden="true">
        <div class="modal-dialog-centered modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header justify-content-between">
...
@section("pagejs")
    <script>
        $(document).ready(function () {
            $('#tableGerneralKarshenasiQuestion').DataTable({
                "order": [],
                "columnDefs": [{
                    "targets": 'no-sort',
                    "orderable": false,
